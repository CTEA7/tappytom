...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-2FDmUHS4.mjs");
...
var manifest = {
	"0504f9fad1f137b625bf5fb1d320a5fef2f0cab413e491a97be13b73ac04b766": {
		functionName: "setUsername_createServerFn_handler",
		importer: () => import("./api-CCWJfwSb.mjs")
	},
	"4a7dba7782a7f37b2020d8a73be0dc1d1c096dcbc0403d9f11356dfe355e6e56": {
		functionName: "submitScore_createServerFn_handler",
		importer: () => import("./api-CCWJfwSb.mjs")
	},
	"7a000c470b38d07563bebf40f091edd1c8d8025155cbf05858f22a8d112c7874": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DgO5RVCO.mjs").then((n) => n.t),
